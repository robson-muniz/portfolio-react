...
const Hero = () => {
  ...
  motto: "Code with purpose ✨"
    ...
    const socialLinks = [
        { icon: '󰊤', href: 'https://github.com/robson-muniz', label: 'GitHub' },
        { icon: '󰌻', href: 'https://www.linkedin.com/in/robsonmuniz/', label: 'LinkedIn' },
        { icon: '𝕏', href: 'https://x.com/WebDevMadeEasy', label: 'Twitter' }
    ];
